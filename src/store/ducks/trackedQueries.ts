...
const byId = (state: TrackedQueriesById = {}, action: ActionType): TrackedQueriesById => {
...
const ids = (state: TrackedQueriesIds = [], action: ActionType): TrackedQueriesIds => {
...
// SELECTORS
const getTrackedQueriesIds = (state: State): TrackedQueriesIds => state.trackedQueries.ids;

const getTrackedQueriesById = (state: State): TrackedQueriesById => state.trackedQueries.byId;
